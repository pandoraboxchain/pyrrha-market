...
// Pjs states
export const PJS_STOPPED = 'PJS_STOPPED';
export const PJS_CONNECTING = 'PJS_CONNECTING';
export const PJS_CONNECTED = 'PJS_CONNECTED';
 ...
 * @event reconnected
 */
export class PjsConnector extends EventEmitter {
...
export default new PjsConnector();

 ...
 * @returns {Promise}
 */
export const bulkInsertOrUpdate = (model, condition = [], values = [], onAfterInsert = () => {}) => {
 ...
 * @returns {Object}
 */
export const extractPaginationQuery = (options = {}) => {
    const pagination = {};
 ...
 * @returns {Array}
 */
export const extractOrderQuery = (options = {}) => {
    let order = [];
 ...
 * @returns {Object}
 */
export const extractFilerQuery = (options = {}) => {
    const filterQuery = {};
